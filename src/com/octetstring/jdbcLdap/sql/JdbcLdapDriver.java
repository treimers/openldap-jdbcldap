 ...
 * <b>jdbc:ldap://host[:port]/base
 * dn[?property1:=value1&property2:=value2&property<i>n</i>:=value<i>n</i>]</b><br
 * for any properties the driver accepts. <b>NOTE</b>: Any extra properties
 * required by jndi's factory may be passed as a property
 * 
...
public class JdbcLdapDriver implements java.sql.Driver {
    ...
    public boolean acceptsURL(java.lang.String str) throws java.sql.SQLException {
        return str.substring(0, 9).equalsIgnoreCase(URL_ID) || str.substring(0, 9).equalsIgnoreCase(DSML_URL_ID)
                || str.substring(0, 9).equalsIgnoreCase(SPML_URL_ID);
    }

    public java.sql.Connection connect(java.lang.String str, java.util.Properties properties)
    ...
    public java.sql.DriverPropertyInfo[] getPropertyInfo(java.lang.String str, java.util.Properties properties)
            throws java.sql.SQLException {
        ...
        props[2] = new DriverPropertyInfo("java.naming.security.authentication",
                "Authentication type - simple, none or SASL type");
        props[3] = new DriverPropertyInfo("SEARCH_SCOPE", "The Search scope");
        props[4] = new DriverPropertyInfo("CACHE_STATEMENT",
                "true or false, wether or not statements should be cached");
