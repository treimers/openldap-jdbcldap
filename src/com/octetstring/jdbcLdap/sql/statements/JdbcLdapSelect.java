 ...
 */
public class JdbcLdapSelect extends com.octetstring.jdbcLdap.sql.statements.JdbcLdapSqlAbs
    ...
    /**
     * Creates new JdbcLdapSql using a connection, a SQL Statement and a cached
     * SqlStore
     */
    ...
    public void init(JndiLdapConnection con, String SQL) throws SQLException {
        ...
        // determine if the search scope is specified, other wise retrieve it from the
        // connection
